...
public class RenderCustomCart extends Render {
    private static final ResourceLocation minecartTextures = new ResourceLocation("network", "models/testcart.png");
