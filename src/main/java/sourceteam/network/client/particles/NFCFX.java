package sourceteam.network.client.particles;
...
/**
 * Created with IntelliJ IDEA. User: Mark Date: 24/02/14 Time: 20:48
 */
public class NFCFX extends EntityFX {
    public static final ResourceLocation texture = new ResourceLocation("network", "textures/particles/nfc.png");
    ...
    public NFCFX(World par1World, double x, double y, double z, double tx, double ty, double tz, float red, float green, float blue, int age) {
