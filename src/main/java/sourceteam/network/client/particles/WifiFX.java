 ...
 */
public class WifiFX extends EntityFX {
    ...
    public WifiFX(World par1World, double x, double y, double z, double tx, double ty, double tz, float red, float green, float blue, int age) {
