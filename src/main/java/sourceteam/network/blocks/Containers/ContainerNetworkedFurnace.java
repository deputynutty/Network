...
import sourceteam.network.blocks.tileentities.TileEntityNetworkedFurnace;
...
public class ContainerNetworkedFurnace extends Container {
    public TileEntityNetworkedFurnace te;
