...
public class initBlocks {
	...
	public static void loadBlocks() {
		...
		NetworkBlocks.server = new BlockServer().setBlockName(prefix + "server").setHardness(1.5F).setCreativeTab(NetworkCore.Network);
		GameRegistry.registerBlock(NetworkBlocks.server, prefix + "server");
		GameRegistry.registerTileEntity(TileEntityServer.class, prefix + "TileEntityServer");
		...
		NetworkBlocks.Bcuser = new BlockBcUser().setBlockName(prefix + "BlockBcUser").setHardness(1.5F).setCreativeTab(NetworkCore.Network).setBlockTextureName("network:BlockBcUser");
		GameRegistry.registerBlock(NetworkBlocks.Bcuser, prefix + "BlockBcUser");
		GameRegistry.registerTileEntity(TileEntityBCUser.class, prefix + "TileEntityBCUser");
