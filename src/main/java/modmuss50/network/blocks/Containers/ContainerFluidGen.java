...
public class ContainerFluidGen extends Container {
    private IInventory lowerChestInventory;
    private int numRows = 3;

    private TileEntityFluidGen tileEntity;

    public ContainerFluidGen(InventoryPlayer player, TileEntityFluidGen tile) {
