...
public class PacketServer extends AbstractPacket {
	...
	public PacketServer(TileEntityServer te) {
		this.posX = te.xCoord;
		this.posY = te.yCoord;
		this.posZ = te.zCoord;
	...
	public void handleClientSide(EntityPlayer player) {
		...
		if (worldObj.getBlock(posX, posY, posZ) == NetworkBlocks.server) {
			TileEntityServer te = (TileEntityServer) worldObj.getTileEntity(posX, posY, posZ);
			if (te != null) {
