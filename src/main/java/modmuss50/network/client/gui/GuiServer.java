...
import modmuss50.network.blocks.Containers.ContainerServer;
...
public class GuiServer extends GuiContainer {
	...
	public GuiServer(InventoryPlayer par1InventoryPlayer, TileEntityServer par2TileEntityFurnace) {
		super(new ContainerServer(par1InventoryPlayer, par2TileEntityFurnace));
