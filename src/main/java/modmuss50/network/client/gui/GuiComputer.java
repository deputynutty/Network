...
public class GuiComputer extends GuiScreen {
    ...
    private static final ResourceLocation tabletTexture = new ResourceLocation("network:textures/gui/computer.png");
    ...
    public void actionPerformed(GuiButton button) {
        for (int i = 0; i < AppManager.apps.size(); i++) {
            if (i == button.id) {
                Minecraft.getMinecraft().displayGuiScreen(new GuiApp(AppManager.apps.get(i), 0));
            }
        }
    }
